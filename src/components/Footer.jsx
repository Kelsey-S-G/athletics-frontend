      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            />
            <h3 className="font-bold text-lg">Ashesi University Athletics</h3>
            <div className="flex items-start space-x-2 text-red-100">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <a
                  href="mailto:athletics@ashesi.edu.gh"
                  className="text-red-100 hover:text-white transition-colors text-sm"
                >
                  athletics@ashesi.edu.gh
                </a>
              </div>
            </div>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="pt-8 mt-8 border-t border-red-700">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-red-100">
            <div className="flex items-center gap-2">
              <span>Built by</span>
              <span className="font-bold">CREATIVES</span>
            </div>
            <div className="flex items-center gap-2">
              <span>Support:</span>
              <a
                href="mailto:creatives@gmail.com"
